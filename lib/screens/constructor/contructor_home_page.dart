...
class ConstructorHomePage extends StatefulWidget {
  static const String id = 'constructorHomePage';

  @override
  _ConstructorHomePageState createState() => _ConstructorHomePageState();
}

class _ConstructorHomePageState extends State<ConstructorHomePage> {
            ...
            child: RoundedButton(
              ...
              onPressFunction: () {
                Navigator.pushNamed(
                  context,
                  ProjectsScreen.id,
                  arguments: ProjectScreenArguments('constructor'),
                );
              },
            ),
          ),
